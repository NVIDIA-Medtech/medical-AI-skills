...
cd "$REPO_ROOT"
python3 skills/nv-reason-cxr/scripts/run_nv_reason_cxr.py skills/nv-reason-cxr/fixtures/synthetic_cxr_input.json --out-dir verifiers/nv_reason_cxr_quality_v1/fixtures/pass_pack/artifacts
