...
- MEDIUM SECURITY/Unknown (SQP-2): The manifest acknowledges that installing packages into the active Python environment is acceptable only when the caller (`skill_manifest.yaml:57`)
- LOW SCHEMA/unexpected_file: Unexpected 'BENCHMARK.md' in skill root (`skills/nv-segment-ctmr/BENCHMARK.md`)
