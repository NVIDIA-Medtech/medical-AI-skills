# nv-segment-ctmr Benchmark

## Scope

This benchmark report covers `nv-segment-ctmr`, Medical AI Skills skill for NV-Segment-CTMR CT/MRI segmentation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
