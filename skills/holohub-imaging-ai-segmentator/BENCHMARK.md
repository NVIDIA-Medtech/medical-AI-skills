# holohub-imaging-ai-segmentator Benchmark

## Scope

This benchmark report covers `holohub-imaging-ai-segmentator`, Medical AI Skills skill for HoloHub imaging_ai_segmentator runtime evidence. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
