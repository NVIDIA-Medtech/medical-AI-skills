# holohub-flow-benchmark Benchmark

## Scope

This benchmark report covers `holohub-flow-benchmark`, Medical AI Skills skill for HoloHub data-flow benchmarking and contract verification. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
