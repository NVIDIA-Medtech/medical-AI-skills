...
- MEDIUM SECURITY/Unknown (LP3): MCP Least Privilege: The skill uses Bash execution, reads/writes files, reads environment variables, and spawns shell commands, but does not  (`SKILL.md:1`)
