# nv-segment-ct Benchmark

## Scope

This benchmark report covers `nv-segment-ct`, Medical AI Skills skill for NV-Segment-CT / VISTA3D CT segmentation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
