# nv-generate-mr-brain Benchmark

## Scope

This benchmark report covers `nv-generate-mr-brain`, Medical AI Skills skill for NV-Generate-CTMR rflow-mr-brain synthetic brain MRI generation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
