# dicom-series-to-volume Benchmark

## Scope

This benchmark report covers `dicom-series-to-volume`, Medical AI Skills skill for single-series CT DICOM to HU-scaled NIfTI conversion. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
