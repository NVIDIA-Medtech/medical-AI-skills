...
- MEDIUM SECURITY/Unknown (SDI-2): The code extracts and emits StudyInstanceUID, SeriesInstanceUID, StudyDescription, StudyDate, and BodyPartExamined to st (`scripts/series_to_volume.py:181`)
- MEDIUM SECURITY/Unknown (SQP-2): DICOM metadata including StudyInstanceUID, SeriesInstanceUID, StudyDescription, StudyDate, and BodyPartExamined is uncon (`scripts/series_to_volume.py:181`)
- LOW SCHEMA/unexpected_file: Unexpected 'BENCHMARK.md' in skill root (`skills/dicom-series-to-volume/BENCHMARK.md`)
