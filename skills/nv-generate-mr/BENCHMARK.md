# nv-generate-mr Benchmark

## Scope

This benchmark report covers `nv-generate-mr`, Medical AI Skills skill for NV-Generate-CTMR rflow-mr synthetic MRI generation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
