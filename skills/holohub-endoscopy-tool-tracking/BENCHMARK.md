# holohub-endoscopy-tool-tracking Benchmark

## Scope

This benchmark report covers `holohub-endoscopy-tool-tracking`, Medical AI Skills skill for HoloHub endoscopy_tool_tracking runtime evidence. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
