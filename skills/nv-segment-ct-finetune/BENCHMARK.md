# nv-segment-ct-finetune Benchmark

## Scope

This benchmark report covers `nv-segment-ct-finetune`, Medical AI Skills skill for NV-Segment-CT / VISTA3D continual-learning finetune. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
