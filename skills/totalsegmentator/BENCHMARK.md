# totalsegmentator Benchmark

## Scope

This benchmark report covers `totalsegmentator`, Medical AI Skills skill for TotalSegmentator CT/MR multilabel segmentation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
