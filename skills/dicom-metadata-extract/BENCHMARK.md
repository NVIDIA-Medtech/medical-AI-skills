...
- MEDIUM SECURITY/Unknown (LP3): MCP Least Privilege: The skill declares no explicit permissions in its metadata yet exercises file_read, file_write, and shell capabilities ( (`SKILL.md:1`)
