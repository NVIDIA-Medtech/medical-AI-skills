# dicom-metadata-extract Benchmark

## Scope

This benchmark report covers `dicom-metadata-extract`, Medical AI Skills skill for DICOM metadata extraction and PHI-tag flagging. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
