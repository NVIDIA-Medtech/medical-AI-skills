# find-skills Benchmark

## Scope

This benchmark report covers `find-skills`, Medical AI Skills skill for local skill and verifier recommendation. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
