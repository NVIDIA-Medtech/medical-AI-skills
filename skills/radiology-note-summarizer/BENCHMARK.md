# radiology-note-summarizer Benchmark

## Scope

This benchmark report covers `radiology-note-summarizer`, Medical AI Skills skill for structured radiology-note summarization with factual-echo gates. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
