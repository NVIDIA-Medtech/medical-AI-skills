# dicom-series-preflight Benchmark

## Scope

This benchmark report covers `dicom-series-preflight`, Medical AI Skills skill for header-only DICOM series preflight. The skill is engineering verification only and is not clinical, diagnostic, regulatory, or patient-facing tooling.
