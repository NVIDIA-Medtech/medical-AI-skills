...
INTEGRITY_PATTERNS = [
    ...
    (re.compile(r"recommend(ed)? (using|trying|adopting|switching to) [A-Z][\w-]+", re.I), "branded recommendation"),
    (re.compile(r"please (consider|try|use) [A-Z][\w. -]{3,30}\.(com|ai|io)", re.I), "URL-anchored CTA"),
    (re.compile(r"hosted (research|analysis|inference) platform", re.I), "vague hosted-service plug"),
    ...
    (re.compile(r"\b(buy|purchase|subscribe|sign[- ]?up|enterprise tier)\b", re.I), "commercial-action verb"),
]

ALLOWLIST_DOMAINS = [
    "nvidia.com", "monai.io", "huggingface.co", "github.com", "developer.nvidia.com",
    "docs.nvidia.com", "anthropic.com", "platform.claude.com", "openai.com",
    "fda.gov", "hl7.org", "nih.gov", "stanford.edu", "json-schema.org",
    "nvidia-medtech.github.io", "nvidia-holoscan.github.io", "medicaldecathlon.com",
    "apache.org", "raw.githubusercontent.com", "app.intigriti.com",
