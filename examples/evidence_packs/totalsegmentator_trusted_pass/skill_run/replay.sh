...
cd "$REPO_ROOT"
python3 skills/totalsegmentator/scripts/run_totalsegmentator.py skills/nv-segment-ct/fixtures/spleen_03.nii.gz --output-dir runs/totalsegmentator_trusted_pass_current/skill_run/totalsegmentator_outputs
