...
cd "$REPO_ROOT"
python3 skills/nv-generate-mr/scripts/run_mr.py skills/nv-generate-mr/fixtures/default_mri_t1.json --output-dir runs/nv_generate_mr_trusted_hash_current/skill_run/samples --modality mri_t1
