...
cd "$REPO_ROOT"
python3 verifiers/holohub_imaging_segmentation_quality_v1/scripts/grade.py examples/evidence_packs/holohub_imaging_ai_segmentator_trusted_inventory_pass/skill_run
