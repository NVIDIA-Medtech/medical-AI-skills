...
cd "$REPO_ROOT"
python3 skills/nv-segment-ct-finetune/scripts/run_finetune.py skills/nv-segment-ct-finetune/fixtures/spleen_micro --output-dir runs/nv_segment_ct_finetune_trusted_smoke_pass/skill_run/artifacts
