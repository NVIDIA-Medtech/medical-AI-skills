...
- started: 2026-05-26T02:12:40.112608+00:00
- finished: 2026-05-26T02:12:40.225065+00:00
- elapsed: 0.112s
- exit code: 0
...
```json
{
  "input": {
    ...
    "image": {
      "format": "png",
      "height": 96,
      "path": "<repo>/examples/evidence_packs/nv_reason_cxr_trusted_mock_pass/skill_run/artifacts/input_synthetic_chest_xray.png",
