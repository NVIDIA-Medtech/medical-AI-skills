...
cd "$REPO_ROOT"
python3 skills/nv-reason-cxr/scripts/run_nv_reason_cxr.py skills/nv-reason-cxr/fixtures/synthetic_cxr_input.json --out-dir examples/evidence_packs/nv_reason_cxr_trusted_mock_pass/skill_run/artifacts
