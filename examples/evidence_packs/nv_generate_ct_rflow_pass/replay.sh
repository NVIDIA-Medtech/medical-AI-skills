...
cd "$REPO_ROOT"
python3 skills/nv-generate-ct-rflow/scripts/run_rflow_ct.py skills/nv-generate-ct-rflow/fixtures/default_config_infer.json --output-dir runs/nv_generate_ct_rflow_gpu_demo/samples
