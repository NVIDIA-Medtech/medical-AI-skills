...
- started: 2026-05-09T22:10:12.379738+00:00
- finished: 2026-05-09T22:10:15.235921+00:00
- elapsed: 2.856s
- exit code: 0
...
```json
{
  "output": {
    ...
    "findings": [
      ...
      "small simple cyst in the right kidney"
    ],
    "impressions": "mild hepatic steatosis and incidental renal cyst, no acute findings",
    "flags_for_followup": [
      "if symptoms persist"
    ]
  },
  "runtime": {
    ...
    "max_tokens": 1024,
    "seed": 42,
    "request_id": "chatcmpl-476645c41c8643278453dfe479e11d81",
    ...
    "llm_tokens_input": 518,
    "llm_tokens_output": 105,
    "elapsed_seconds": 2.7046
  }
}
```
