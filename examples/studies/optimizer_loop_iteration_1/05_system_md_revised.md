...
- `findings` (array of short strings): each item is one observation
  drawn from the note. must always include dicom_metadata.Modality and BodyPartExamined verbatim in findings or impressions
- `impressions` (string, ≤ 280 chars): a concise impression of the
  study.
