...
- started: 2026-05-09T22:10:25.328076+00:00
- finished: 2026-05-09T22:10:28.070163+00:00
- elapsed: 2.742s
- exit code: 0
...
```json
{
  "output": {
    ...
    "findings": [
      ...
      "CT abdomen with contrast shows a 1.5 cm simple cyst in the right kidney"
    ],
    "impressions": "CT abdomen with contrast shows mild hepatic steatosis and a 1.5 cm simple cyst in the right kidney; no acute findings.",
    "flags_for_followup": [
  ...
  "runtime": {
    ...
    "max_tokens": 1024,
    "seed": 42,
    "request_id": "chatcmpl-951b2a0ff37c59fc",
    ...
    "llm_tokens_output": 732,
    "elapsed_seconds": 2.6454
  }
}
```
