...
help-all:
	...
	@echo "  study ACTION=<audit|preflight|transfer-manifest|approval-packet|approved-rerun-plan|status|prove-agent-skills|prove-with-vs-without|plan>   one-stop dispatcher"
...
study:
	...
	case "$$action" in \
	  ...
	  "") echo "Usage: make study ACTION=<audit|preflight|transfer-manifest|approval-packet|approved-rerun-plan|status|prove-agent-skills|prove-with-vs-without|plan>" >&2; exit 2 ;; \
