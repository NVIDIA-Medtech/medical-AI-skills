...
orchestrators. It intentionally writes compact study JSON/Markdown under
examples/studies/with_vs_without_skill/ and keeps generated volumes/checkpoints
under runs/ so large artifacts remain gitignored.
"""
...
PROMPT_ARTIFACT_ANSWER = (
    "Backend response is captured in examples/studies/with_vs_without_skill; "
