...
| `write_nv_model_reports.py` | Regenerates per-skill Markdown reports and `docs/with-vs-without-skill-experiment.md` from study JSON. |
...
Regenerate Markdown reports after all required study JSON exists:
