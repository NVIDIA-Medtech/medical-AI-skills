...
def _run(cmd: list[str], env_extra: dict[str, str] | None = None, timeout: int = 600) -> dict:
    env = os.environ.copy()
    if env_extra:
...
async def finetune_smoke(
    config: FinetuneSmokeConfig, _builder: Builder
