...
DICOM/NIfTI/DICOM SEG artifacts, model weights, raw HoloHub recordings, or
provider logs with secrets. A committed evidence pack must be small enough to
